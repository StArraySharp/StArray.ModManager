...
/// 所有方法通过 <c>[DllImport("modloader")]</c> 调用 <c>libmodloader.so</c>。
/// </summary>
public static class Dobby
{
    ...
    [DllImport(Lib, EntryPoint = "modloader_dobby_hook")]
    ...
    [DllImport(Lib, EntryPoint = "modloader_dobby_instrument")]
    ...
    /// <returns>0 = 成功</returns>
    [DllImport(Lib, EntryPoint = "modloader_dobby_destroy")]
    ...
    [DllImport(Lib, EntryPoint = "modloader_dobby_symbol_resolver")]
